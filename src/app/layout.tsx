...
export const metadata: Metadata = {
  title: "Brew & Bean - Premium Coffee Shop | Freshly Roasted Daily",
  description: "Experience artisan coffee at Brew & Bean. Freshly roasted beans, expert crafted beverages, and cozy atmosphere. Order online or visit us today.",
  keywords: "coffee shop, artisan coffee, fresh roasted beans, espresso, latte, cappuccino, premium coffee",
  openGraph: {
    title: "Brew & Bean - Premium Coffee Shop",
    description: "Experience artisan coffee at Brew & Bean. Freshly roasted beans, expert crafted beverages, and cozy atmosphere.",
    siteName: "Brew & Bean",
    images: [
      {
